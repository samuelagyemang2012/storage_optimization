...
mds_cache_memory_limit=$(( $RANDOM % (1073741824 + 1 - 5073741824) + 1073741824))
...
mds_cache_trim_threshold=$(( $RANDOM % (65536 + 1 - 85000) + 65536))
...
mds_recall_max_caps=$(( $RANDOM % (5000 + 1 - 8000) + 5000))
params[5]=$mds_recall_max_caps

mds_recall_max_decay_threshold=$(( $RANDOM % (16384 + 1 - 28000) + 16384))
...
mds_recall_global_max_decay_threshold=$(( $RANDOM % (65536 + 1 - 85000) + 65536))
params[8]=$mds_recall_global_max_decay_threshold

mds_recall_warning_threshold=$(( $RANDOM % (32768 + 1 - 86000) + 32768))
...
mds_session_cap_acquisition_throttle=$(( $RANDOM % (500000 + 1 - 1000000) + 500000))
...
mds_session_cache_liveness_magnitude=$(( $RANDOM % (10 + 1 - 20) + 10))
...
mds_max_caps_per_client=$(( $RANDOM % (1048576 + 1 - 3000000) + 1048576))
...
mds_dir_max_commit_size=$(( $RANDOM % (10 + 1 - 30) + 10))
...
mds_bal_split_size=$(( $RANDOM % (10000 + 1 - 80000) + 10000))
...
mds_bal_split_bits=$(( $RANDOM % (1 + 1 - 24) + 1))
params[40]=$mds_bal_split_bits

mds_bal_merge_size=$(( $RANDOM % (50 + 1 - 100) + 50))
params[41]=$mds_bal_merge_size

mds_bal_interval=$(( $RANDOM % (10 + 1 - 50) + 10))
params[42]=$mds_bal_interval

mds_bal_fragment_interval=$(( $RANDOM % (5 + 1 - 20) + 5))
...
mds_bal_fragment_size_max=$(( $RANDOM % (100000 + 1 - 500000) + 100000))
...
mds_bal_max=$(( $RANDOM % (-1 + 1 - 2) + -1))
params[47]=$mds_bal_max

mds_bal_max_until=$(( $RANDOM % (-1 + 1 - 2) + -1))
params[48]=$mds_bal_max_until

mds_bal_mode=$(( $RANDOM % (1 + 1 - 3) + 1))
...
mds_shutdown_check=$(( $RANDOM % (1 + 1 - 5) + 1))
params[57]=$mds_shutdown_check

mds_thrash_exports=$(( $RANDOM % (1 + 1 - 5) + 1))
params[58]=$mds_thrash_exports

mds_thrash_fragments=$(( $RANDOM % (1 + 1 - 5) + 1))
...
mds_kill_mdstable_at=$(( $RANDOM % (1 + 1 - 6) + 1))
params[67]=$mds_kill_mdstable_at

mds_kill_export_at=$(( $RANDOM % (1 + 1 - 6) + 1))
params[68]=$mds_kill_export_at

mds_kill_import_at=$(( $RANDOM % (1 + 1 - 6) + 1))
params[69]=$mds_kill_import_at

mds_kill_link_at=$(( $RANDOM % (1 + 1 - 5) + 1))
params[70]=$mds_kill_link_at

mds_kill_rename_at=$(( $RANDOM % (1 + 1 - 5) + 1))
...
mds_skip_ino=$(( $RANDOM % (1 + 1 - 4) + 1))
params[74]=$mds_skip_ino

mds_min_caps_per_client=$(( $RANDOM % (100 + 1 - 500) + 100))
...
bluestore_deferred_batch_ops=$(( $RANDOM % (1 + 1 - 64) + 1))
params[79]=$bluestore_deferred_batch_ops

bluestore_deferred_batch_ops_hdd=$(( $RANDOM % (64 + 1 - 128) + 64))
params[80]=$bluestore_deferred_batch_ops_hdd

bluestore_deferred_batch_ops_ssd=$(( $RANDOM % (16 + 1 - 128) + 16))
params[81]=$bluestore_deferred_batch_ops_ssd

bluestore_fsck_read_bytes_cap=$(( $RANDOM % (67108864 + 1 - 87108864) + 67108864))
params[82]=$bluestore_fsck_read_bytes_cap

bluestore_max_deferred_txc=$(( $RANDOM % (32 + 1 - 120) + 32))
params[83]=$bluestore_max_deferred_txc

bluestore_prefer_deferred_size=$(( $RANDOM % (1 + 1 - 24) + 1))
params[84]=$bluestore_prefer_deferred_size

bluestore_prefer_deferred_size_hdd=$(( $RANDOM % (32768 + 1 - 50000) + 32768))
params[85]=$bluestore_prefer_deferred_size_hdd

bluestore_prefer_deferred_size_ssd=$(( $RANDOM % (1 + 1 - 2400) + 1))
params[86]=$bluestore_prefer_deferred_size_ssd

bluestore_throttle_bytes=$(( $RANDOM % (67108864 + 1 - 97108864) + 67108864))
...
client_cache_size=$(( $RANDOM % (16384 + 1 - 34000) + 16384))
params[89]=$client_cache_size

client_oc=$[ $RANDOM % 2]
params[90]=$client_oc

client_oc_max_dirty=$(( $RANDOM % (104857600 + 1 - 104857600) + 104857600))
...
client_oc_max_objects=$(( $RANDOM % (1000 + 1 - 10000) + 1000))
params[93]=$client_oc_max_objects

client_oc_size=$(( $RANDOM % (209715200 + 1 - 509715200) + 209715200))
params[94]=$client_oc_size

client_oc_target_dirty=$(( $RANDOM % (8388608 + 1 - 12000000) + 8388608))
params[95]=$client_oc_target_dirty

client_readahead_max_bytes=$(( $RANDOM % (1 + 1 - 1024) + 1))
params[96]=$client_readahead_max_bytes

client_readahead_max_periods=$(( $RANDOM % (4 + 1 - 20) + 4))
params[97]=$client_readahead_max_periods

client_readahead_min=$(( $RANDOM % (131072 + 1 - 450000) + 131072))
params[98]=$client_readahead_min

ms_async_max_op_threads=$(( $RANDOM % (5 + 1 - 24) + 5))
params[99]=$ms_async_max_op_threads

ms_async_op_threads=$(( $RANDOM % (1 + 1 - 24) + 1))
params[100]=$ms_async_op_threads

osd_bench_max_block_size=$(( $RANDOM % (67108864 + 1 - 80000000) + 67108864))
params[101]=$osd_bench_max_block_size

osd_bench_small_size_max_iops=$(( $RANDOM % (100 + 1 - 500) + 100))
params[102]=$osd_bench_small_size_max_iops

osd_pool_default_cache_max_evict_check_size=$(( $RANDOM % (10 + 1 - 50) + 10))
params[103]=$osd_pool_default_cache_max_evict_check_size

osd_pool_default_cache_min_evict_age=$(( $RANDOM % (1 + 1 - 10) + 1))
params[104]=$osd_pool_default_cache_min_evict_age

osd_pool_default_cache_min_flush_age=$(( $RANDOM % (1 + 1 - 10) + 1))
...
osd_target_transaction_size=$(( $RANDOM % (30 + 1 - 50) + 30))
params[109]=$osd_target_transaction_size

osd_tier_default_cache_hit_set_count=$(( $RANDOM % (4 + 1 - 8) + 4))
params[110]=$osd_tier_default_cache_hit_set_count

osd_tier_default_cache_hit_set_grade_decay_rate=$(( $RANDOM % (20 + 1 - 50) + 20))
params[111]=$osd_tier_default_cache_hit_set_grade_decay_rate

osd_tier_default_cache_hit_set_period=$(( $RANDOM % (1200 + 1 - 2400) + 1200))
params[112]=$osd_tier_default_cache_hit_set_period

osd_tier_default_cache_hit_set_search_last_n=$(( $RANDOM % (1 + 1 - 5) + 1))
params[113]=$osd_tier_default_cache_hit_set_search_last_n

osd_tier_default_cache_min_read_recency_for_promote=$(( $RANDOM % (1 + 1 - 5) + 1))
params[114]=$osd_tier_default_cache_min_read_recency_for_promote

osd_tier_default_cache_min_write_recency_for_promote=$(( $RANDOM % (1 + 1 - 5) + 1))
...
rbd_cache_max_dirty=$(( $RANDOM % (25165824 + 1 - 50000000) + 25165824))
...
rbd_cache_max_dirty_object=$(( $RANDOM % (1 + 1 - 5) + 1))
params[120]=$rbd_cache_max_dirty_object

rbd_cache_size=$(( $RANDOM % (33554432 + 1 - 5120000) + 33554432))
params[121]=$rbd_cache_size

rbd_cache_target_dirty=$(( $RANDOM % (16777216 + 1 - 24000000) + 16777216))
...
rbd_readahead_disable_after_bytes=$(( $RANDOM % (52428800 + 1 - 80000000) + 52428800))
params[126]=$rbd_readahead_disable_after_bytes

rbd_readahead_max_bytes=$(( $RANDOM % (524288 + 1 - 1240000) + 524288))
